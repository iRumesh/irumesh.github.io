...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.png" alt="Rumesh"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Rumesh</td></tr>
					<tr><td>Profession</td><td>Engineer</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Resume</td><td><a href="/resume/2023.pdf" download>Download Resume</a></td></tr>
					<!-- <tr><td>Portfolio</td><td><a href="https://rumesh-portfolio.onrender.com" target="_blank">View Now</a></td></tr> -->
					<tr><td>Last Active</td><td>Now</td></tr>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Rumesh Facial Recognition">
		...
		<div class="profile-info">
			<table>
				<tbody>
					...
					<tr><td>Match</td><td>88%</td></tr>
					<tr><td>Location</td><td>[6.933939234932007, 79.85017537877644]</td></tr>
				</tbody>
			</table>
		</div>`,
  },
  {
    ...
    html: `
			<div class="finland-map-wrap">
				<img class="finland-map" src="${imagePath}/finland-map.png" alt="Finland Map">
  ...
  },
  {
    ...
    width: 240,
    html: `<div class="profile-image"><img src="${imagePath}/my-cat.png" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Simba</td></tr>
					<tr><td>Alias</td><td>Sim</td></tr>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://www.slt.lk/">SLT</a></td><td>Colombo, Sri Lanka</td><td>2022 - Present</td><td><a href="#" onclick="modal(event)" data-title="SLT">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://gpv-group.com/">GPV</a></td><td>Negambo, Sri Lanka</td><td>unknown - 2022</td><td><a href="#" onclick="modal(event)" data-title="GPV">Full Report</a></td></tr>
					<!-- <tr><td>Working from home</td><td>Remote</td><td>2015 - 2024 </td><td><a href="#" onclick="modal(event)" data-title="Working from home">Full Report</a></td></tr> -->
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
			<tbody>
				<tr><td width="50%">C++</td><td>Python</td></tr>
				<tr><td width="50%">HTML</td><td>CSS</td></tr>
        <tr><td>JavaScript</td><td>yaml</td></tr>
				<tr><td>TypeScript</td><td>Markdown</td></tr>
				<tr><td>C</td><td>Verilog</td></tr>
				<tr><td>PHP</td><td>Latex</td></tr>
  ...
  },
  {
    ...
    html: `<table>
			<tbody>
        <tr><td>Embedded Systems Development</td></tr>
        <tr><td>Custom IIoT Solutions</td></tr>
        <tr><td>Web Development</td></tr>
        <tr><td>Mobile App Development</td></tr>
        <tr><td>Research & Development</td></tr>
...
if (window.location.pathname === "/findme/") {
  new Terminal({
    ...
    commands: [
      {
        // text: 'load profile -firstName "Rumesh" -alias "Rebel"',
        text: 'load profile -Name "Rumesh"',
        typing: true,
      },
      {
        text: "loading...",
...
var missions = {
  ...
  "GPV": `
		<h3>Role</h3>
		<p>Test Development Engineer</p>

		<h3>Directives</h3>
		<p>● Involved in verification & testing of PCBs manufactured in Factory.</p>
    <p>● Created Measurement system analysis reports and Manuals for PCB test adapters which was used by technicians at the factory for performing tests for manufactured PCBs/UUTs/DUTs.</p>
    <p>● Partially contributed to implementation of PCB Test Adapters/p>
    <p>● Performed manual functional testing and high voltage testing of PCBs with given test specification</p>
    <p>● Used redmine for project management & SVN for version control & Circuit studio for PCB Design/p>
	`,
  "SLT": `
		<h3>Role</h3>
		<p>R&D Engineer</p>
		...
		<h3>Directives</h3>
    <p>● From industrial requirments, doing research, analyzing the feasibility and developing a projects.</p>
    <p>● Used modern development tools such as Git and GitHub to collaborate on code and create version control.</p>
    <p>● Developing a project from PoC to final product deployment</p>
    <p>● Providing a long term support to Small Medium Enterprise(SME) Customers (Hardware/Software Debug).</p>
    ...
    <p>● Communicate IIoT best practices to the team, enhancing efficiency and performance across the department</p>
	`,
};
